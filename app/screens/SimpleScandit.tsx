...
import { Alert, AppState, AppStateStatus, BackHandler, PermissionsAndroid, Platform } from 'react-native';
import {
  BarcodeCapture,
...
export default function SimpleScandit(): ReactComponent {
  ...
  const dataCaptureContext = useMemo(() => {
    ...
    return DataCaptureContext.forLicenseKey(EXPO_PUBLIC_SCANDIT_LICENSE_KEY);
  }, []);
